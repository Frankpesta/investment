...
const ChooseUs = () => {
  return (
<section className="py-10 bg-gray-200 sm:py-16 lg:py-20 my-8">
    ...
    <div className="grid grid-cols-1 gap-5 mt-12 sm:grid-cols-3 lg:mt-20 lg:gap-x-12">
      ...
      <div className="transition-all duration-200 bg-white hover:shadow-xl">
        <div className="py-10 px-9">
          ...
          <h3 className="mt-8 text-lg font-semibold text-black">Positive Impact</h3>
          <p className="mt-4 text-base text-gray-600">We believe in corporate social responsibility and actively engage in initiatives that promote sustainability, social welfare, and community development.Through partnerships with nonprofit organizations, volunteer programs, and responsible investment practices, we strive to contribute to a better future for all.</p>
        </div>
      </div>
      <div className="transition-all duration-200 bg-white hover:shadow-xl">
        <div className="py-10 px-9">
          ...
          <h3 className="mt-8 text-lg font-semibold text-black">Education</h3>
          <p className="mt-4 text-base text-gray-600">Education is at the core of our philosophy. We believe that informed clients are empowered clients. As such, we offer a wide range of educational resources, including seminars, webinars, and personalized training sessions, to enhance our clients' financial literacy and equip them with the knowledge to make well-informed decisions.</p>
        </div>
      </div>
    </div>
  </div>
