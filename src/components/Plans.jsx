    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          <h1 className="sm:text-4xl text-3xl font-medium title-font mb-2 text-teal-700">
            Packages
          </h1>
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">
            Select from our range of packages and start your journey with us...
          </p>
          <div className="flex mx-auto overflow-hidden mt-6">
            <h2 className="text-xl font-bold uppercase">Crypto Currency Plans</h2>
          </div>
        </div>
        <div className="flex flex-wrap -m-4">
          ...
          <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
            <div className="h-full p-6 rounded-lg border-2 border-teal-500 flex flex-col relative overflow-hidden">
              ...
              <p className="text-xs text-gray-500 mt-3">1% Interest Rate</p>
            </div>
          </div>
          <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
            <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
      ...
      <div className="container px-5 pb-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          <div className="flex mx-auto overflow-hidden mt-6">
            <h2 className="text-xl font-bold uppercase">Real Estate Plans</h2>
          </div>
        </div>
        <div className="flex flex-wrap -m-4">
          <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
          ...
          <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
            <div className="h-full p-6 rounded-lg border-2 border-teal-500 flex flex-col relative overflow-hidden">
              ...
              <p className="text-xs text-gray-500 mt-3">35% Interest Rate</p>
            </div>
          </div>
          <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
            <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
