    ...
    <section className="py-10 bg-gray-100 sm:py-16 lg:py-24">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="text-lg pt-2 leading-tight text-black uppercase sm:text-2xl lg:text-3xl">
        ...
        <div className="grid max-w-md grid-cols-1 gap-6 mx-auto mt-8 text-center lg:max-w-full lg:mt-16 lg:grid-cols-4">
          {planDetails.map((deets) => (
            <div
              key={deets.name}
              className="overflow-hidden bg-white border-2 border-gray-100 rounded-md h-fit"
            >
              <div className="p-6 xl:px-12">
                ...
                <button
                  className="inline-flex items-center justify-center px-10 py-4 mt-10 text-base font-semibold text-white transition-all duration-200 rounded-md bg-gradient-to-r from-teal-600 to-blue-400 hover:opacity-80 focus:opacity-80"
                  role="button"
                  onClick={handleClick}
                >
                  {" "}
          ...
          {RealEstatePlans.map((deets) => (
            ...
            >
              <div className="p-6 xl:px-12">
                ...
                <p className="mt-3 text-base text-gray-600">
                  {deets.percentage} Monthly Profit
                </p>
                <ul className="inline-flex flex-col items-start space-y-5 text-left mt-9">
                  <li className="inline-flex items-center space-x-2">
                    <svg
