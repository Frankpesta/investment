...
// import { profileEdit, reset } from "../../app/services/auth/profileSlice";
import { useNavigate } from "react-router-dom";
// import { MyEditValues, MyUpdateValues } from "../../app/services/type";
...
export default function EditProfile() {
  ...
  const SignupSchema = Yup.object().shape({
    ...
    country: Yup.string().min(0, "Too Short!").max(10, "Too Long!"),
  });
